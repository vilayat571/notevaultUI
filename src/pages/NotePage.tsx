...
import { ArrowLeft, Edit3, Trash2, Save, BookOpen, Video, FileText, GraduationCap, StickyNote, ExternalLink, Globe, Lock, X, Download, MessageCircle, Send, User, UserPlus, UserMinus, Share2, Check } from 'lucide-react'
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body { font-family: 'Nunito', sans-serif; color: #1a1a2e; line-height: 1.7; }
    .cover-img { display: block; width: 100%; height: 300px; object-fit: cover; }
    .cover-solid { width: 100%; height: 300px; }
    .wrapper { width: 90%; margin: 0 auto; padding: 44px 0 64px; }
    header { border-bottom: 3px solid #f59e0b; padding-bottom: 24px; margin-bottom: 32px; }
    h1 { font-size: 36px; font-weight: 800; color: #111827; line-height: 1.2; margin-bottom: 10px; letter-spacing: -0.5px; }
    .author-line { font-family: 'Courier New', monospace; font-size: 13px; color: #9ca3af; margin-bottom: 4px; }
    .description { font-size: 15px; color: #4b5563; font-style: italic; margin-top: 10px; }
    .section-title { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; color: #9ca3af; margin-bottom: 14px; font-family: 'Courier New', monospace; }
    .content-box { background: #f9fafb; border: 1px solid #e5e7eb; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 32px 40px; }
    .content-box p { margin-bottom: 14px; font-size: 15px; color: #374151; }
    .content-box p:last-child { margin-bottom: 0; }
    .content-box h1, .content-box h2, .content-box h3 { color: #111827; font-weight: 700; margin: 20px 0 10px; }
    .content-box h1 { font-size: 22px; } .content-box h2 { font-size: 19px; } .content-box h3 { font-size: 16px; }
    .content-box ul, .content-box ol { margin: 10px 0 14px 22px; }
    .content-box li { margin-bottom: 6px; font-size: 15px; color: #374151; }
    .content-box blockquote { border-left: 3px solid #d1d5db; padding-left: 16px; color: #6b7280; font-style: italic; margin: 14px 0; }
    .content-box strong { color: #111827; } .content-box em { color: #4b5563; }
    .content-box code { font-family: 'Courier New', monospace; background: #e5e7eb; padding: 2px 6px; border-radius: 4px; font-size: 13px; }
    .content-box pre { background: #e5e7eb; padding: 16px; border-radius: 6px; overflow: auto; margin: 14px 0; font-family: 'Courier New', monospace; font-size: 13px; }
    .content-box img { display: block; max-width: 100%; width: 100%; height: auto; object-fit: contain; border-radius: 6px; margin: 18px 0; }
    .empty-note { color: #9ca3af; font-style: italic; font-size: 15px; }
    footer { margin-top: 52px; padding-top: 20px; border-top: 1px solid #e5e7eb; font-family: 'Courier New', monospace; font-size: 11px; color: #d1d5db; display: flex; justify-content: space-between; }
    @media print {
...
<body>
  ...
  <\/script>
    ...
    if (printWindow) printWindow.onload = () => URL.revokeObjectURL(url)
  }
  // ───────────────────────────────────────────────────────────────────────────
